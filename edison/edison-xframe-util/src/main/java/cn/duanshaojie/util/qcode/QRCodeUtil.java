package cn.duanshaojie.util.qcode;
...
public class QRCodeUtil {
	...
	public static BufferedImage encode1(String content, String imgPath, String destPath, boolean needCompress) throws Exception {
	...
	public static void main(String[] args) throws Exception {
		...
		QRCodeUtil.encode(text, "./qrcodeImage.png", "./", true);
	}
